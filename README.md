...
1. Clone o repositório do Projeto [Blog Pessoal](https://github.com/cdouradom/Blog-Pessoal) dentro da pasta do *Workspace* do STS
 
```bash
git clone git@github.com:cdouradom/Blog-Pessoal.git
```
